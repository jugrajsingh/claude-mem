...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",E={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},m=new te;var Bt={};function $t(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Oe.fileURLToPath)(Bt.url))}var Ft=$t();function Pt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,se.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,H.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=Pt(),M=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,se.homedir)(),".claude"),Es=(0,f.join)(M,"plugins","marketplaces","thedotmack"),gs=(0,f.join)(C,"archives"),Ts=(0,f.join)(C,"logs"),fs=(0,f.join)(C,"trash"),Ss=(0,f.join)(C,"backups"),bs=(0,f.join)(C,"modes"),jt=(0,f.join)(C,"settings.json"),Ae=(0,f.join)(C,"claude-mem.db"),hs=(0,f.join)(C,"vector-db"),x=null,Xt=5e3;function Ht(){let r=Date.now();if(!x||r-x.loadedAt>Xt)try{x={value:y.loadFromFile(jt).CLAUDE_MEM_OBSERVER_SESSION_DIR||(0,f.join)(C,"observer-sessions"),loadedAt:r}}catch{x={value:(0,f.join)(C,"observer-sessions"),loadedAt:r}}return x.value}var Gt=Ht(),re=(0,f.basename)(Gt),Os=(0,f.join)(M,"settings.json"),As=(0,f.join)(M,"commands"),Rs=(0,f.join)(M,"CLAUDE.md");function Re(r){(0,H.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,f.join)(Ft,"..")}var ye=require("crypto");var Ie=require("os"),Le=D(require("path"),1);var B=require("fs"),G=D(require("path"),1),k={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Ne(r){let e=G.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",u),k}if(!t.isFile())return k;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(u){return console.warn("[worktree] Failed to read .git file:",u instanceof Error?u.message:String(u)),k}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return k;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return k;let a=i[1],d=G.default.basename(r),c=G.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}function De(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,Ie.homedir)()):r}function Wt(r){if(!r||r.trim()==="")return m.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=De(r),t=Le.default.basename(e);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return m.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return m.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}function ne(r){let e=Wt(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=De(r),s=Ne(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var Vt=3e4;function W(r,e,t){return(0,ye.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function V(r,e,t){let s=t-Vt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function Yt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return h;let e=Yt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Me(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function qt(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var Y=class{db;constructor(e=Ae){e!==":memory:"&&Re(C),this.db=new ve.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns()}initializeSchema(){this.db.run(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=qt(n,o),c=d.platformSource??h,u=this.db.prepare(`
    ...
    `).get(e);if(u){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let g=u.platform_source?.trim()?v(u.platform_source):void 0;if(!g)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),u=W(e,s.title,s.narrative),E=V(this.db,u,d);if(E)return{id:E.id,createdAtEpoch:E.created_at_epoch};let T=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let g=[],T=this.db.prepare(`
      ...
      `);for(let S of s){let p=W(e,S.title,S.narrative),R=V(this.db,p,c);if(R){g.push(R.id);continue}let l=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,S.agent_type??null,S.agent_id??null,p,u,c,d||null);g.push(Number(l.lastInsertRowid))}let O=null;if(n){let p=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let l of s){let b=W(e,l.title,l.narrative),fe=V(this.db,b,E);if(fe){O.push(fe.id);continue}let Dt=S.run(e,t,l.type,l.title,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),a||null,d,l.agent_type??null,l.agent_id??null,b,g,E,u||null);O.push(Number(Dt.lastInsertRowid))}let p;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function ue(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ae)}function Fe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function gt(r,e,t,s){let n=[];return s?n.push(...rt(r)):n.push(...Ge(r)),s?n.push(...nt()):n.push(...Be()),s?n.push(...ot()):n.push(...We()),s?n.push(...it()):n.push(...Ve()),K(t)&&(s?n.push(...at(e,t)):n.push(...Ye(e,t))),n}var le=D(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Ee(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ge(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ft(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Tt(r,e){return le.default.isAbsolute(r)?le.default.relative(e,r):r}function St(r,e,t){let s=Z(r);if(s.length>0)return Tt(s[0],e);if(t){let n=Z(t);if(n.length>0)return Tt(n[0],e)}return"General"}function es(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ft(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function bt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function ts(r,e,t,s){let n=[];n.push(...qe(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Ee(a.displayTime);n.push(...ze(a,d))}else{let a=i.data,d=ge(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let g=bt(a,s);n.push(...Qe(a,u,g,s))}else n.push(Je(a,u,s))}return n}function ss(r,e,t,s,n){let o=[];o.push(...dt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,u=Ee(c.displayTime);o.push(...mt(c,u))}else{let c=d.data,u=St(c.files_modified,n,c.files_read),E=ge(c.created_at),g=E!==a;a=E;let T=t.has(c.id);if(u!==i&&(o.push(..._t(u)),i=u),T){let O=bt(c,s);o.push(...ut(c,E,g,O,s))}else o.push(ct(c,E,g,s))}return o.push(""),o}function rs(r,e,t,s,n,o){return o?ss(r,e,t,s,n):ts(r,e,t,s)}function ht(r,e,t,s,n){let o=[],i=es(r);for(let[a,d]of i)o.push(...rs(a,d,e,t,s,n));return o}function Ot(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function At(r,e){let t=[];return e?(t.push(...P("Investigated",r.investigated,_.blue)),t.push(...P("Learned",r.learned,_.yellow)),t.push(...P("Completed",r.completed,_.green)),t.push(...P("Next Steps",r.next_steps,_.magenta))):(t.push(...F("Investigated",r.investigated)),t.push(...F("Learned",r.learned)),t.push(...F("Completed",r.completed)),t.push(...F("Next Steps",r.next_steps))),t}function Rt(r,e){return e?pt(r):Ze(r)}function Ct(r,e,t){return!K(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?lt(r.totalDiscoveryTokens,r.totalReadTokens):et(r.totalDiscoveryTokens,r.totalReadTokens)}var ns=Nt.default.join((0,It.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function os(){try{return new Y}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Lt.unlinkSync)(ns)}catch(e){e instanceof Error?m.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):m.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return m.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function is(r,e){return e?Et(r):tt(r)}function as(r,e,t,s,n,o,i){let a=[],d=_e(e);a.push(...gt(r,d,s,i));let c=t.slice(0,s.sessionCount),u=je(c,t),E=pe(e,u),g=Xe(e,s.fullObservationCount);a.push(...ht(E,g,s,n,i));let T=t[0],O=e[0];Ot(s,T,O)&&a.push(...At(T,i));let S=me(e,s,o,n);return a.push(...Rt(S,i)),a.push(...Ct(d,s,i)),a.join(`
`).trimEnd()}async function Te(r,e=!1){let t=ie(),s=r?.cwd??process.cwd(),n=ne(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=os();if(!a)return"";try{let d=o.length>1?Fe(a,o,t):ce(a,i,t),c=o.length>1?Pe(a,o,t):ue(a,i,t);return d.length===0&&c.length===0?is(i,e):as(i,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
